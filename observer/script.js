...
setInterval(() => {
  timerSubject.notify(counter)
  counter++
}, 600);

setInterval(() => {
  timerSubject.notify(counter2)
  counter2++
}, 2300);
...
setInterval(() => {
  ...
  obsConfig.subject.addObserver(obsConfig.newObserver);
...
addBtn.onclick = addNewObserver.bind(controlCheckbox);
